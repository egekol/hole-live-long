Shader "UI/Hidden/UI-Effect-Shiny-Brightness"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				half luminance = reflectColor.r * 0.3 + reflectColor.g * 0.59 + reflectColor.b * 0.11;
				half3 finalColor = (shinePower / 2) * IN.effectFactor.w * luminance;
				color.a = (finalColor.r + finalColor.g + finalColor.b / 3) * originAlpha;
		
				color.rgb = originAlpha * (shinePower / 2) * IN.effectFactor.w * luminance;
				return color;
			}
